...
public class MainActivity8 extends AppCompatActivity {
    ...
    private int initialProgress = 91;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (correctCardIndices.size() < 1) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (correctCardIndices.contains(cardIndex)) {
                        ...
                        RightActivity.r = 50000;

                        Intent screen = new Intent(MainActivity8.this, RightActivity.class);
                        ...
                        textViewNote.setVisibility(View.GONE);
                        Intent screen = new Intent(MainActivity8.this, WrongActivity.class);
                        startActivity(screen);
                    }
                }
            });
        ...
        buttonAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentCoinCount>=5000){
                    ...
                    Toast.makeText(MainActivity8.this, "Not Enough Chips!", Toast.LENGTH_SHORT).show();
                }
            }
        });
