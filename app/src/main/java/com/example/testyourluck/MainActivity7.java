...
public class MainActivity7 extends AppCompatActivity {
    ...
    private int initialProgress = 78;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (correctCardIndices.size() < 2) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (correctCardIndices.contains(cardIndex)) {
                        ...
                        RightActivity.r = 1000;

                        Intent screen = new Intent(MainActivity7.this, RightActivity.class);
                        ...
                        textViewNote.setVisibility(View.GONE);
                        Intent screen = new Intent(MainActivity7.this, WrongActivity.class);
                        startActivity(screen);
                    }
                }
            });
        ...
        buttonAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentCoinCount>=5000){
                    ...
                    Toast.makeText(MainActivity7.this, "Not Enough Chips!", Toast.LENGTH_SHORT).show();
                }
            }
        });
