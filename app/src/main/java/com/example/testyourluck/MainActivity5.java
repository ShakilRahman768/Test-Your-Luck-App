...
public class MainActivity5 extends AppCompatActivity {
    ...
    private int initialProgress = 52;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (correctCardIndices.size() < 4) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (correctCardIndices.contains(cardIndex)) {
                        ...
                        Intent screen = new Intent(MainActivity5.this, RightActivity.class);
                        ...
                        textViewNote.setVisibility(View.GONE);
                        Intent screen = new Intent(MainActivity5.this, WrongActivity.class);
                        startActivity(screen);
                    }
                }
            });
        ...
        buttonAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentCoinCount>=5000){
                    ...
                    Toast.makeText(MainActivity5.this, "Not Enough Chips!", Toast.LENGTH_SHORT).show();
                }
            }
        });
