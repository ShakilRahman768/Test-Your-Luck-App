...
public class MainActivity2 extends AppCompatActivity {
    ...
    private int initialProgress = 13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (correctCardIndices.size() < 7) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (correctCardIndices.contains(cardIndex)) {
                        ...
                        Intent screen = new Intent(MainActivity2.this, RightActivity.class);
                        ...
                        textViewNote.setVisibility(View.GONE);
                        Intent screen = new Intent(MainActivity2.this, WrongActivity.class);
                        startActivity(screen);
                    }
                }
            });
        ...
        buttonAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentCoinCount>=5000){
                    ...
                    Toast.makeText(MainActivity2.this, "Not Enough Chips!", Toast.LENGTH_SHORT).show();
                }
            }
        });
