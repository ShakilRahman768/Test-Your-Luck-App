...
public class MainActivity4 extends AppCompatActivity {
    ...
    private int initialProgress = 39;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        while (correctCardIndices.size() < 5) {
            ...
            card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (correctCardIndices.contains(cardIndex)) {
                        ...
                        Intent screen = new Intent(MainActivity4.this, RightActivity.class);
                        ...
                        textViewNote.setVisibility(View.GONE);
                        Intent screen = new Intent(MainActivity4.this, WrongActivity.class);
                        startActivity(screen);
                    }
                }
            });
        ...
        buttonAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(currentCoinCount>=5000){
                    ...
                    Toast.makeText(MainActivity4.this, "Not Enough Chips!", Toast.LENGTH_SHORT).show();
                }
            }
        });
